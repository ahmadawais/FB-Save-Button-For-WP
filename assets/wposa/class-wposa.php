<?php
/**
 * Main Class file for `WP_OSA_FBS`
 *
...
class WP_OSA_FBS {
	...
	public function admin_menu() {
	    ...
	    add_options_page( 'FB Save Button', 'FB Save Button', 'manage_options', 'fb_save_button_settings', array( $this, 'plugin_page' ) );

	}

	public function plugin_page() {
	    echo '<div class="wrap">';
	    	echo '<h1>Facebook Save Button for WP <span style="font-size:50%;">v' . FBS_VERSION . '</span></h1>';
